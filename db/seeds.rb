...
#     last_name:'mishra',
#     user_type: 'teacher',
#     email:'rahul'"#{i}"'@gmail.com',
#     username:'rahul1'"#{i}",
#     password:'rahuls@1234',
...
# 5.times do |i|
#  User.create( first_name: 'sadique#{i}', last_name: 'ansari#{i}', username: 'sid23#{i}', email: 'saduiq#{i}@gmail.com', password: 'sid@22#{i}', user_type: 'student', profile_picture: 'sid#{i}.jpg')
# end   
